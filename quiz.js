...
function governmentcheck(){
	...
	var policeofficer = 0;
	var informationclerk = 0;

	var q48=document.governmentquiz.question48.value;
	if(q48=="A"){
		policeofficer++
	}
	var q49=document.governmentquiz.question49.value;
	if(q49=="A"){
		policeofficer++
		firstresponder++
	}
	var q50=document.governmentquiz.question50.value;
	if(q50=="A"){
		policeofficer++
	}
	var q51=document.governmentquiz.question51.value;
	if(q51=="A"){
		policeofficer++
	}
	var q52=document.governmentquiz.question52.value;
	if(q52=="A"){
		informationclerk++
	}
	var q53=document.governmentquiz.question53.value;
	if(q53=="A"){
		informationclerk++
	}
	var q54=document.governmentquiz.question54.value;
	if(q54=="A"){
		firstresponder++
	}

	var selected6 = Math.max(policeofficer,firstresponder,informationclerk);
	
	if (firstresponder==selected6) {
		var med = "You were chosen to be a First Responder";
		var medbold = med.bold();
		document.write(medbold)
		document.write("<br>Primary duties: A first responder is a certified medical specialist who arrives at the scene of an emergency. They complete any necessary medical tasks before taking the individual to a hospital.<br>United States<br>2019 Employment: 174,800<br>2029 Employment: 177,600<br>Percent of Change: 1.6%<br>Projected Openings: 11,100<br>National Typical Salary: $16.20 per hour")
	}
	else if(policeofficer==selected6) {
		var med = "You were chosen to be a Police Officer";
		var medbold = med.bold();
		document.write(medbold)
		document.write("<br> Primary duties: Police enforcement is responsible for maintaining public order. They protect the people, enforce local laws and work to prevent dangerous crimes.<br>United States<br>2019 Employment: 692,900<br>2029 Employment: 732,100<br>Percent of Change:5.7%<br>Projected Openings: 51,300<br>National Typical Annual Salary: $50,446")
	}
	else if(informationclerk==selected6) {
		var med = "You were chosen to be an Information Clerk";
		var medbold = med.bold();
		document.write(medbold)
		document.write("<br> An information clerk maintains reports, bills, and government orders. They often act as an information source to the public about government regulations or policies.<br>United States<br>2019 Employment: 1,105,300<br>2029 Employment: 1,144,700<br>Percent of Change:3.6%<br>Projected Openings: 139,200<br>National Typical Annual Salary: $61,715")
	}
